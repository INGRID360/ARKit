...
//        objectViewController.popoverPresentationController?.sourceRect = button.bounds
    ...
    func addPlane(node: SCNNode, anchor: ARPlaneAnchor) {
		...
		textManager.showDebugMessage("NY YTA UPPTÄCKT VID \(pos.friendlyString())")
		...
		textManager.showMessage("YTA UPPTÄCKET")
		if !VirtualObjectsManager.shared.isAVirtualObjectPlaced() {
			textManager.scheduleMessage("TAP + FÖR ATT PLACERA OBJEKT", inSeconds: 7.5, messageType: .contentPlacement)
		}
	}
	...
	func restartPlaneDetection() {
		...
		textManager.scheduleMessage("HITTA EN YTA FÖR ATT PLACERA OBJEKTET", inSeconds: 7.5, messageType: .planeEstimation)
	}
    ...
    func setupFocusSquare() {
        ...
        textManager.scheduleMessage("PROVA FLYTTA KAMERA HÖGER / VÄNSTER", inSeconds: 5.0, messageType: .focusSquare)
    }
