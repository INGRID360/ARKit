...
class TextManager {
	...
	func escalateFeedback(for trackingState: ARCamera.TrackingState, inSeconds seconds: TimeInterval) {
		...
		self.trackingStateFeedbackEscalationTimer = Timer.scheduledTimer(withTimeInterval: seconds,
			...
			case .notAvailable:
				title = "Spårningsstatus: Ej tillgänglig."
				message = "Spårningsstatus har varit begränsad en längre tid. Prova att starta om sessionen."
			case .limited(let reason):
				title = "Spårningsstatus: Begränsad."
				message = "Spårningsstatus har varit begränsad under en längre tid. "
				switch reason {
				case .excessiveMotion: message += "Sakta ner dina rörelser, eller starta om sessionen."
				case .insufficientFeatures: message += "Rikta kameran mot en platt yta."
                case .initializing: message += "Initializing."
                case .relocalizing: message += "Initializing."
